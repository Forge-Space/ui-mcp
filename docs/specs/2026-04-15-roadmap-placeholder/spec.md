...
## Goal
Bootstrap the spec + roadmap workflow for ui-mcp. Future feature work uses `docs/specs/<date>-<slug>/{spec,tasks}.md` with YAML frontmatter and regenerates `docs/roadmap.md` from spec `status:`.
